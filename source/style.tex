...
\setupinteraction
  [state=start,                 % turn on hyperlink functionality
   color=linkcolor,             % the default color for links
   contrastcolor=linkcontrast,  % for links that go somewhere in the same page
...
\setuphead  % adjust how 'chapter' headings look & behave
  [chapter]
  [align={flushleft,broad}, style=\bfd, color=headercolor, page=no]

\setuphead  % adjust how 'section' headings look & behave
  [section]
  [align={flushleft,broad}, style=\bfb, color=headercolor]
